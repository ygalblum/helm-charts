...
*/}}
{{- define "marketplace-assistant.vault-init-container" -}}
...
*/}}
{{- define "marketplace-assistant.vault-base-volumes" -}}
- name: vault-ca-cert
  configMap:
...
- name: vault-agent-config
  configMap:
    name: {{ printf "%s" (include "marketplace-assistant.vault-agent-config-configmap" .) }}
{{- end }}
...
*/}}
{{- define "marketplace-assistant.vault-instance-volumes" -}}
- name: {{ printf "vault-%s" (.outputVolumeName | default "output") }}
  emptyDir:
    medium: Memory
...
*/}}
{{- define "marketplace-assistant.vault-agent-config-configmap" -}}
{{- printf "%s-%s" (include "marketplace-assistant.fullname" .) "vault-agent-config" }}
{{- end }}

{{/*
Vault Agent config
*/}}
{{- define "marketplace-assistant.vault-agent-config" -}}
...
*/}}
{{- define "marketplace-assistant.vault-template-slackbot-configmap" -}}
{{- printf "%s-%s" (include "marketplace-assistant.fullname" .) "vault-template-slackbot-configmap" }}
{{- end }}

{{/*
Vault Template for Slackbot
*/}}
{{- define "marketplace-assistant.vault-template-slackbot" -}}
{{`
...
*/}}
{{- define "marketplace-assistant.vault-template-vllm-configmap" -}}
{{- printf "%s-%s" (include "marketplace-assistant.fullname" .) "vault-template-vllm-configmap" }}
{{- end }}

{{/*
Vault Template for vLLM
*/}}
{{- define "marketplace-assistant.vault-template-vllm" -}}
{{`
...
*/}}
{{- define "marketplace-assistant.vault-template-ingest-configmap" -}}
{{- printf "%s-%s" (include "marketplace-assistant.fullname" .) "vault-template-ingest-configmap" }}
{{- end }}

{{/*
Vault Template for Ingest
*/}}
{{- define "marketplace-assistant.vault-template-ingest" -}}
{{`
...
*/}}
{{- define "marketplace-assistant.vault-template-fluent-bit-configmap" -}}
{{- printf "%s-%s" (include "marketplace-assistant.fullname" .) "vault-template-fluent-bit-configmap" }}
{{- end }}

{{/*
Vault Template for Fluent-Bit Configuration file
*/}}
{{- define "marketplace-assistant.vault-template-fluent-bit" -}}
[SERVICE]
  Flush 1
